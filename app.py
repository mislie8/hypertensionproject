...
app = Flask(__name__)
#  choose anything as your secret key
...
#  loading the machine learning mlodel
...
def predict():
    ...
    if (physactivity == 1):
        ...
        physactivity= 'not physically active'
    if (fruits == 1):
        fruits= 'consume fruits 1 or more time per day'
    else:
        fruits= 'do not consume fruits'
    if (veggies == 1):
        veggies= 'consume veggies 1 or more time per day'
    else:
        veggies= 'do not consume veggies'
    if (alcohol == 1):
        alcohol= 'alcohol'
    else:
        alcohol= 'no alcohol'
    if (age == 1):
        ...
        ag1 ='80 years old and older'
# rturning prediction result, report and suggestion
    return render_template('form.html', prediction_text=f'This is your report: Your age group is {ag1}, you are a {sex}, you are a {smoker}, you are {physactivity}, you {fruits}, you {veggies}, you have {alcohol} in your daily diet, your body mass index is {bmi} kg/m². Your result is: {prediction}')
